  ...
  theme: {
    ...
    extend: {
      ...
      animation: {
        ...
        "bubble-pulse": "bubble-pulse 3s ease-in-out infinite",
        "bubble-inflate": "bubble-inflate 0.6s ease-out forwards",
        "bubble-shrink": "bubble-shrink 0.6s ease-out forwards",
        "bubble-burst": "bubble-burst 0.8s ease-out forwards",
